    ...
    function replace_variables($content, $member, $data)
    {
        ...
        $replacements = [
            ...
            'agent' => [
                ...
                '*|LISTING_STREET|*' => isset($data['listing']) ? $data['listing']->address_street : '',
                '*|LISTING_NUMBER|*' => isset($data['listing']) ? $data['listing']->address_number : '',
                '*|LISTING_SYSTEM_PRICE|*' => isset($data['listing']) ? $data['listing']->system_price : '',
                '*|LISTING_NAME|*' => isset($data['listing']) ? $data['listing']->name : '',
                '*|URL|*' => '',
                '*|SUBJECT_THIS_EMAIL|*' => $data['subject'],
                '*|LOGO|*' => $data['logo'],

                '*|FIRST_VIEW|*' => isset($data['view']) ? $data['view']->created_at : '',
                '*|VIEW_COUNT|*' => isset($data['view']) ? $data['view']->count : '',
                '*|LISTING_VIEWER|*' => '',
                '*|CONTENT|*' => '',
                '*|SELLING_AGENT|*' => '',
                '*|LOCATION_TYPE|*' => '',
