        ...
        <tbody>
            ...
            <tr>
                <td style="border: none; border-bottom: 1px solid lightgrey;background-color: #F9F9F9;"> 
                    ...
                    <p style="padding: 5px 20px;"> Meghan Porter wants to Schedule a viewing at 626 Main St.Toronto 61600 - $32,000<br>
                     Phone :207337652<br>
                     Email:meghan@fxxx.com
                    </p> 
                    <p style="padding: 5px 20px;">(Property Address) was first viewed by (first name) on (date) and has been viewed # Times.<br>
                      The price has been reduced on this property by $42,000 and reduction occured on July 24,2017<br><br>                     
                    </p>                    
               	</td> 
            </tr>
