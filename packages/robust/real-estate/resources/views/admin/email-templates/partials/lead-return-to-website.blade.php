        ...
        <tbody>
            ...
            <tr>
                <td style="border: none; border-bottom: 1px solid lightgrey;background-color: #F9F9F9;"> 
                    ...
                    <p style="padding: 5px 20px;"> Meghan Porter who registered on (date) has returned to website <br>
                     Phone :207337652<br>
                     Email:meghan@fxxx.com
                    </p> 

                    <p style="padding: 5px 20px;">(Lead first name) is live looking on the website right now and this is a repeat visit.
                    </p>
               	</td> 
            </tr>
            <tr>
