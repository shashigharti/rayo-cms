        ...
        <div class="panel card">
            ...
            <div class="col s12 communication--block">
                <ul class="collapsible" data-collapsible="accordion">
                    <li>
                        <div class="collapsible-header"><i class="material-icons">add</i>Weekly Property Update <span></span></div>
                                    ...
                                    <tr>
                                        <td style="text-align: center; background-color: #315C85; padding: 10px 15px;">
                                            <p>
                                                ...
                                                <br>
                                                <br>
                                                <i style="color: white; font-family: verdana; font-size: 12px;background-color: #315C85">This message is intended for Vega Norma who registered on <a style="color:#1ba71b" href="#">https://4alaskarealestate.com</a> To stop these emails, <a style="color:#1ba71b" href="#">Click here</a>.</i> </p>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
