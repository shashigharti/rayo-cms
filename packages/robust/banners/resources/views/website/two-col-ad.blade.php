...
@foreach($TwoColAds as $key => $TwoColAd)
    ...
    @if($properties)
        ...
        @set('url',!in_array($properties->button_url,['','#']) ? $properties->button_url : route('website.realestate.homes-for-sale', ['location_type' => 'cities', 'location' => $properties->location]))
