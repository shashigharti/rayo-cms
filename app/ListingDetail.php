...
class ListingDetail extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['lakewaterfront', 'off_market_date',
        ...
        'well', 'window', 'other_buildings', 'zoning', 'community_features', 'parking_features', 'property_description', 'architecture', 'seperate_den_office', 'other_rooms'];
    ...
    {
        return $this->belongsTo(\App\Listings::class, 'id', 'listing_id');
    }
